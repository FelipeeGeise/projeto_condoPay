    ...
    return (
        ...
        <main className={styles.main}>
            <ul className={styles.userList}>
                <li
                    className={active === "condominio" ? styles.active : ""}
                    onClick={() => setActive("condominio")}
                >
                    <Image src="/img/Group.png" alt="group" width={23} height={21} />
                    <span>Condomínio</span>
                </li>

                <li
                    className={active === "unidade" ? styles.active : ""}
                    onClick={() => setActive("unidade")}
                >
                    <Image src="/img/Unidade.png" alt="unidade" width={23} height={21} />
                    <span>Unidades</span>
                </li>

                <li
                    className={active === "usuarios" ? styles.active : ""}
                    onClick={() => setActive("usuarios")}
                >
                    <Image src="/img/usuario.png" alt="usuario" width={23} height={21} />
                    <span>Usuários</span>
                </li>
            </ul>
            ...
            <div className={styles.infoBox}>
                ...
                <button className={styles.infoButton} onClick={() => setShowModal(true)}>
                    <Image src="/img/sairvermelho.png" alt="sairvermelhopng" width={18} height={18} />
                    ...
                    <div className={styles.texteum}>
                        <div className={styles.logosavatar}>
                            <div className={styles.avatarum}>
                                <Image src="/img/fotocondominio.png" alt="fotocondominio" width={101} height={101} />
                                <p>Foto do Condomínio</p>
                            </div>

                            <div className={styles.avatardois}>
                                <Image src="/img/logocondominio.png" alt="logocondominio" width={101} height={101} />
            ...
            {showModal && (
                <div className={styles.modalOverlay}>
                    <div className={styles.modal}>
                        ...
                        <p>Você tem certeza que vai sair? Você perderá todos os acessos e registros referentes a este condomínio.</p>
